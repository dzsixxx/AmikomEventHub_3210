...
<body class="bg-slate-50 text-slate-900 flex min-h-screen">
    ...
    <aside class="w-64 bg-indigo-900 text-indigo-100 flex flex-col p-6 space-y-8 sticky top-0 h-screen">
        ...
        <nav class="flex-1 space-y-2">
            ...
            <!-- Tambahkan Menu Manajemen Partner di sini -->
        ...
        <div class="pt-6 border-t border-indigo-800">
            <a href="{{ route('home') }}"
                ...
                <form action="{{ route('admin.logout') }}" method="POST" class="mt-auto pt-6 border-t border-indigo-800">
                    @csrf
                    <button type="submit" class="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-red-500 hover:bg-red-600 text-white font-bold transition">
